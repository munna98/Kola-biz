...
export const api = {
  ...
  customers: {
    ...
    batchCreate: (data: CreateCustomer[]) => invoke<number>('batch_create_customers', { customers: data }),
  ...
  suppliers: {
    ...
    batchCreate: (data: CreateSupplier[]) => invoke<number>('batch_create_suppliers', { suppliers: data }),
